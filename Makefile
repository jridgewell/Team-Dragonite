...
debug: $(yaml_builddir)/yaml.a
	$(CXX) $(CXXFLAGS) -g -ansi -Wall -Wunused -Wextra -Wswitch -Wshadow -Wmissing-braces -Wreturn-type -Wparentheses -Wmissing-field-initializers -Wsign-compare -Wmissing-prototypes -o main *.cpp utils/*.cpp $^
clean:
